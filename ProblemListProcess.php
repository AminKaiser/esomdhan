...
<html>
	...
	<body>
		...
		<div class="toppane" style=" margin: -80px 0px 0px 0px;">
			...
			<div style="margin: -40px 0px 0px 55px;">
				<form action="searchproblem.php" method="POST">
	...
	<div style="margin:80px 0px 0px 0px;">	
		...
		<tbody>
		<?php
		$query="Select userinfo.username,		probleminfo.problem_id,probleminfo.description,probleminfo.district,probleminfo.types,probleminfo.City,probleminfo.status
